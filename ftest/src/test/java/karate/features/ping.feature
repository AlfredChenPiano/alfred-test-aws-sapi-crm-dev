Feature: Test scenarios for alfred-test-aws-sapi-crm-dev API for ping method

  Background:
   	* url alfred-test-aws-sapi-crm-dev_url 
    * header client_id = alfred-test-aws-sapi-crm-dev_client_id
    * header client_secret = alfred-test-aws-sapi-crm-dev_client_secret
    * path 'api/v1/ping'
